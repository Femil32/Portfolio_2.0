...
function Social() {
    return (
        <div className='social_icons z-[99999] left-10 bottom-4 items-center justify-center text-black-300 opacity-0 dark:text-white-300 lg:fixed lg:flex lg:flex-col'>
